...
type GreeterClient interface {
	Greet(ctx context.Context, in *HelloRequest, opts ...grpc_go.CallOption) (*HelloReply, common.ErrorWithAttachment)
}
...
type GreeterClientImpl struct {
	Greet func(ctx context.Context, in *HelloRequest) (*HelloReply, error)
}
...
func (c *greeterClient) Greet(ctx context.Context, in *HelloRequest, opts ...grpc_go.CallOption) (*HelloReply, common.ErrorWithAttachment) {
	out := new(HelloReply)
...
func _Greeter_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc_go.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
